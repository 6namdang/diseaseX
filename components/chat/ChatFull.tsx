/**
 * Full chat screen with on-device RAG. This module is only evaluated in a
 * development build or production build where the custom native modules
 * (llama.rn, react-native-fs) are linked. The Expo Go client loads
 * {@link ../chat/ChatStub} instead; see app/(tabs)/chat.tsx for the shim
...
const emptyStyles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.semibold, fontSize: 18, color: palette.text },
  body: {
    fontFamily: fonts.regular,
    fontSize: 14,
    color: palette.textSecondary,
...
const mdStyles = {
  ...
  heading1: { fontFamily: fonts.bold, fontSize: 18, color: palette.text, marginVertical: 6 },
  heading2: { fontFamily: fonts.bold, fontSize: 16, color: palette.text, marginVertical: 4 },
  heading3: { fontFamily: fonts.semibold, fontSize: 15, color: palette.text, marginVertical: 4 },
