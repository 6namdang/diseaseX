          ...
          <View style={styles.modelRow}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.modelSub}>
                <T>
                  MobileNetV2 binary classifier + Claude Vision stage analysis. Images are posted
                  to the classifier endpoint; no data is retained server-side.
                </T>
              </Text>
            </View>
          </View>
        ...
        {photoUri && (
          <GlassCard intensity={34}>
            ...
            <View style={styles.imageActions}>
              <Pressable
                onPress={pickFromCamera}
                style={({ pressed }) => [styles.ghostBtn, fx && pressed && { opacity: 0.85 }]}
              >
